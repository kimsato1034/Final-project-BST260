...
Finally we drew the ROC curve using the testing dataset. However, AUC is 0.61, which means this model might be better than our previous model but still not so good for predicting over-ride.
